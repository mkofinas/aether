...
def build_flags():
    ...
    parser.add_argument(
        '--mode', choices=['train', 'eval', 'save_pred', 'visualize_field'],
        required=True)
    ...
    parser.add_argument('--tune_on_mse', action='store_true')
    ...
    parser.add_argument('--field_hidden', type=int, default=256)
