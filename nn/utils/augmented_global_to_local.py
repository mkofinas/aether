...
from nn.utils.canonicalization import (
    canonicalize_augmented_inputs,
    create_augmented_edge_attr_pos_vel,
    create_augmented_3d_edge_attr_pos_vel
)


class AugmentedLocalizer(nn.Module):
    # Boolean Tuple Keys: use_3d
    _global_to_local_fn = {
        0: create_augmented_edge_attr_pos_vel,
        1: create_augmented_3d_edge_attr_pos_vel,
    }
    ...
    def forward(self, x):
        ...
        rel_feat, Rinv = canonicalize_augmented_inputs(x, self.use_3d)
