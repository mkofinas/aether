...
SEED=1
MODEL_TYPE="nn.seq2seq.dnri.DNRI"
EXPERIMENT_EXT=""
...
TRAINING_ARGS='--add_uniform_prior --no_edge_prior 0.5 --batch_size 64 --lr 5e-4 --use_adam --num_epochs 600 --lr_decay_factor 0.5 --lr_decay_steps 600 --normalize_kl --normalize_nll --tune_on_mse --val_teacher_forcing --teacher_forcing_steps -1'
mkdir -p $WORKING_DIR
