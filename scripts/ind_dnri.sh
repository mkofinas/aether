...
SEED=1
MODEL_TYPE="nn.dynamicvars.dnri_dynamicvars.DNRIDynamicVars"
EXPERIMENT_EXT=""
...
TRAINING_ARGS="--batch_size 8 --sub_batch_size 1 --val_batch_size 1 --max_burn_in_count 6 --test_short_sequences --lr 5e-4 --use_adam --num_epochs 600 --lr_decay_factor 0.5 --lr_decay_steps 200 --normalize_kl --normalize_nll --tune_on_mse --val_teacher_forcing --teacher_forcing_steps -1 --train_data_len 30"
...
EVAL_ARGS="--strict 6 --test_short_sequences --report_error_norm --train_data_len 50 --batch_size 1 --max_burn_in_count 6 --verbose --final_test --error_out_name test_prediction_errors_burnin6.npy --load_best_model"
